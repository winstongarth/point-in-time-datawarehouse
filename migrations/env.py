...
# alembic.ini. Our application code connects with plain psycopg using a
# "postgresql://" DSN; SQLAlchemy needs the driver named explicitly, hence the
# "+psycopg" insert.
_app_dsn = get_settings().database_url
_sqlalchemy_url = _app_dsn.replace("postgresql://", "postgresql+psycopg://", 1)
